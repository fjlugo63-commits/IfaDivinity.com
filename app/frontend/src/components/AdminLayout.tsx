...
const engineItems = [
  { label: 'House Profiles', path: '/admin/engine/houses', icon: Home },
  { label: 'Awo Profiles', path: '/admin/engine/awos', icon: UserCheck },
  { label: 'Rule Versions', path: '/admin/engine/rules', icon: Shield },
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      ...
      >
        ...
        <nav className="mt-4 px-3 space-y-1 overflow-y-auto max-h-[calc(100vh-80px)]">
