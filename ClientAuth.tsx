...
import { Mail, UserPlus, Sparkles, Shield, Lock } from 'lucide-react';
  ...
  async function handlePasswordLogin(e: React.FormEvent) {
    ...
    if (error) {
      ...
      if (msg.toLowerCase().includes('invalid login credentials')) {
        toast.error('Invalid credentials. Try the magic link option or check your password.', { duration: 5000 });
      } else {
          ...
          <Tabs defaultValue="login" className="w-full">
            ...
            <TabsContent value="login" className="mt-0">
              <CardHeader className="pb-4">
                ...
                <CardDescription>
                  {usePasswordLogin ? 'Sign in with your email and password' : 'Sign in with your email — no password needed'}
                </CardDescription>
              </CardHeader>
              <CardContent>
                {magicLinkSent ? (
                  ...
                  <form onSubmit={handlePasswordLogin} className="space-y-4">
                    <div className="space-y-2">
                      <Label htmlFor="login-email-pw">Email Address</Label>
                      <Input
                        id="login-email-pw"
                        type="email"
