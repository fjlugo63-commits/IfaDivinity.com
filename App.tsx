...
const AdminAuditLogDetail = lazy(() => import('./pages/admin/AdminAuditLogDetail'));
...
const AdminConsultationRequests = lazy(() => import('./pages/admin/AdminConsultationRequests'));
...
const ClientRequestConsultation = lazy(() => import('./pages/ClientRequestConsultation'));
const ClientCheckout = lazy(() => import('./pages/ClientCheckout'));
const ClientPaymentSuccess = lazy(() => import('./pages/ClientPaymentSuccess'));
const ClientConsultationDetail = lazy(() => import('./pages/ClientConsultationDetail'));
const ClientConsultationMessages = lazy(() => import('./pages/ClientConsultationMessages'));
...
const AppRoutes = () => (
  <Suspense fallback={<PageLoader />}>
    <Routes>
      ...
      {/* Client Portal - Auth routes outside layout (no auth required) */}
      <Route path="/client/auth" element={<ClientAuth />} />
      <Route path="/client/login" element={<ClientLogin />} />
      <Route path="/client/register" element={<ClientRegister />} />
      <Route path="/client/verify/:token" element={<ClientVerifyEmail />} />
      ...
      <Route path="/client" element={<ClientLayout />}>
        ...
        <Route path="consultations/:id" element={<ClientConsultationDetail />} />
        <Route path="request-consultation" element={<ClientRequestConsultation />} />
        <Route path="checkout/:requestId" element={<ClientCheckout />} />
        <Route path="payment-success" element={<ClientPaymentSuccess />} />
        <Route path="messages/:consultationId" element={<ClientConsultationMessages />} />
      ...
      <Route path="/admin" element={<AdminLayout />}>
        ...
        <Route path="engine/consultations/requests" element={<AdminConsultationRequests />} />
        <Route path="engine/audit" element={<AdminAuditLogs />} />
        <Route path="engine/audit-logs" element={<AdminAuditLogs />} />
        <Route path="engine/audit/:id" element={<AdminAuditLogDetail />} />
        <Route path="engine/audit-logs/:id" element={<AdminAuditLogDetail />} />
