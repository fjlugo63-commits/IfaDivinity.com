  ...
  async function handleSignIn(e: React.FormEvent) {
    ...
    if (error) {
      ...
      if (msg.toLowerCase().includes('invalid login credentials')) {
        toast.error('Invalid login credentials. Please check your email and password. If you are a Client, use the Client Portal instead.', {
          duration: 6000,
          action: {
            label: 'Client Portal',
          ...
          <CardContent>
            ...
            <div className="mt-4 pt-4 border-t">
              <p className="text-sm text-center text-muted-foreground">
                Are you a client?{' '}
                <a href="/client/auth" className="text-amber-600 hover:underline font-medium">
